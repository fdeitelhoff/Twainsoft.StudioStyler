...
namespace System.Windows.Data
{
    ...
    public sealed class PagedCollectionView : ICollectionView, IPagedCollectionView, IEditableCollectionView, INotifyPropertyChanged
    {
        ...
        /// <summary>
        /// Raise own PropertyChangedEvents to provide a WPF binding.
        /// </summary>
        private void RaiseOwnPropertyChangedEvents()
        {
            // Fabian Deitelhoff, 05. April 2013: Raise events in case of WPF binding.
        ...
        /// <summary>
        /// Gets the current page (not 0 based!)
        /// </summary>
        ...
        /// <summary>
        /// The first item number on the current page.
        /// </summary>
        ...
        /// <summary>
        /// The last item number on the current page.
        /// </summary>
        public int LastItemNumber
        {
            get
            {
                ...
                end = (end > TotalItemCount) ? TotalItemCount : end + 1;
